...
def englishNumber number
	if number < 0 # No negative numbers.
		return "Please enter a number isn't negative."
	end
	if number == 0
		return "zero"
	end
...
while count > 0
	puts "#{englishNumber(count)} bottles of beer on the wall. #{englishNumber(count)} bottles of beer. Take one down pass it around #{englishNumber(count - 1)} bottles of beer on the wall."
	count -= 1
end